...
import { Loader2, Wand2, UploadCloud, File, X, Lightbulb, ListOrdered, Scale, Milestone, CheckSquare, FileSignature } from 'lucide-react';
...
type CaseStrategyViewProps = {
    caseSummary: string;
};

export function CaseStrategyView({ caseSummary }: CaseStrategyViewProps) {
    const [userSummary, setUserSummary] = useState(caseSummary);
